   ...
   return (
     <div className=" p-5 border-[2px] border-gray-500 rounded-lg w-[300px] h-[150px]">
       ...
       <div className="text-center"  >
         <h1 className="text-[13px]" > <span>Company:- </span> {companyName}</h1>
         <h1 className="text-[13px]" > <span>duration:- </span> {duration}</h1>
         <h1 className="text-[13px]" > <span>Technology :- </span> {skills}</h1>
       </div>
     </div>
   );
 }
